...
class Moss:
    ...
    def addFile(self, file_path, display_name):
    ...
    def uploadFile(self, s, fileString, display_name, file_id):
    ...
    def send(self):
        ...
        index = 1
        for fileString, display_name in self.files:
            self.uploadFile(s, fileString, display_name, index)
            index += 1
